...
export default function AccountSetup2Create() {
  console.log("In AccountSetup2Create.js");
  ...
  const handleNext = () => {
    console.log("AccountSetup2Create.js formData: ", formData);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formContainer}>
        <TextInput style={styles.input} onChangeText={(text) => handleChange("email", text)} value={formData.email} placeholder='Email' keyboardType='email-address' />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.subHeaderText}>Make a strong passcode that will be very hard to guess. View our security guidelines here.</Text>
      </View>

      <View style={styles.formContainer}>
        <TextInput style={styles.input} onChangeText={(text) => handleChange("password", text)} value={formData.password} placeholder='Create Password' secureTextEntry />
        <TextInput
          style={styles.input}
