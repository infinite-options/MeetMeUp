...
import MatchPageNew from './Profile/MatchPageNew';
import MatchResultsPage from './Profile/MatchResultsPage';
  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/matchpage" element={<MatchPageNew/>}/>
        <Route path="/matchresults" element={<MatchResultsPage/>}/>
      </Routes>
    </BrowserRouter>
