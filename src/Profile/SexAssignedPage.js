...
const genderOptions = data.gender || []; // Default to an empty array if no gender data
  ...
  return (
    ...
    >
      ...
      <Box style={{ width: '100%', marginBottom: '16px' }}>
        ...
        >
          Your sex assigned at birth will NOT be public.
        </Typography>
      </Box>
...
export default SexAssignedPage;
