...
import 'account_setup4_interests_copy_model.dart';
export 'account_setup4_interests_copy_model.dart';

class AccountSetup4InterestsCopyWidget extends StatefulWidget {
  const AccountSetup4InterestsCopyWidget({Key? key}) : super(key: key);

  @override
  _AccountSetup4InterestsCopyWidgetState createState() =>
      _AccountSetup4InterestsCopyWidgetState();
}

class _AccountSetup4InterestsCopyWidgetState
    extends State<AccountSetup4InterestsCopyWidget> {
  late AccountSetup4InterestsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSetup4InterestsCopyModel());
