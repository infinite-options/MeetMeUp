...
import 'account_setup3_details_copy_model.dart';
export 'account_setup3_details_copy_model.dart';

class AccountSetup3DetailsCopyWidget extends StatefulWidget {
  const AccountSetup3DetailsCopyWidget({Key? key}) : super(key: key);

  @override
  _AccountSetup3DetailsCopyWidgetState createState() =>
      _AccountSetup3DetailsCopyWidgetState();
}

class _AccountSetup3DetailsCopyWidgetState
    extends State<AccountSetup3DetailsCopyWidget> {
  late AccountSetup3DetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSetup3DetailsCopyModel());
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 10.0),
                                child: Text(
                                  'Your location helps us pin point where you are to provide \nbetter matches for you',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Open Sans',
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  validator: _model
                                      .openToTextFieldControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Container(
