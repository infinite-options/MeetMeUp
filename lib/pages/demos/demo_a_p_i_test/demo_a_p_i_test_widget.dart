...
import 'demo_a_p_i_test_model.dart';
export 'demo_a_p_i_test_model.dart';

class DemoAPITestWidget extends StatefulWidget {
  const DemoAPITestWidget({Key? key}) : super(key: key);

  @override
  _DemoAPITestWidgetState createState() => _DemoAPITestWidgetState();
}

class _DemoAPITestWidgetState extends State<DemoAPITestWidget> {
  late DemoAPITestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DemoAPITestModel());
