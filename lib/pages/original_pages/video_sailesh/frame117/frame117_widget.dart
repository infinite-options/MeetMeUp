...
import 'frame117_model.dart';
export 'frame117_model.dart';

class Frame117Widget extends StatefulWidget {
  const Frame117Widget({Key? key}) : super(key: key);

  @override
  _Frame117WidgetState createState() => _Frame117WidgetState();
}

class _Frame117WidgetState extends State<Frame117Widget> {
  late Frame117Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Frame117Model());
