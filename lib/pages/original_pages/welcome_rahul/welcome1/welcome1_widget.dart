              ...
              Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/unsplash_RXnwBfUgwoA_(1).png',
                      width: 392.0,
                      height: 846.0,
                      fit: BoxFit.cover,
                    ),
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 16.0, 0.0, 0.0),
                                  child: Text(
                                    'You’re now a meet me up member',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Lexend',
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 16.0, 0.0, 0.0),
                                    child: Text(
                                      'Thank you for signing up to become a meet me up member. Let’s get you out there to make some matches.',
