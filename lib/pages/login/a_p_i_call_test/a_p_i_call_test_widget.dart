...
import 'a_p_i_call_test_model.dart';
export 'a_p_i_call_test_model.dart';

class APICallTestWidget extends StatefulWidget {
  const APICallTestWidget({Key? key}) : super(key: key);

  @override
  _APICallTestWidgetState createState() => _APICallTestWidgetState();
}

class _APICallTestWidgetState extends State<APICallTestWidget> {
  late APICallTestModel _model;
